            ...
            <div class="col">
                <div class="main-content">
                    ...
                    <div class="container mt-5">
                        <h2>Lista de Tabletas</h2>
                        <a href="agregar_tableta.php" class="btn btn-success mb-3">Agregar Tableta</a>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>ID</th>
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editar_tableta.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Editar</a>
                                            <a href="eliminar_tableta.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de eliminar esta tableta?');">Eliminar</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
