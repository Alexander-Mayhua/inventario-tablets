...
<body>
    ...
    <div class="container-fluid p-0">
        <div class="row g-0">
            ...
            <div class="col-auto">
                <div class="sidebar">
                    <h4 class="px-3 mb-4">Alexander</h4>
                    <ul class="nav flex-column">
                        ...
                        <a href="login.php" class="btn btn-danger p-3 m-3">Cerrar sesión</a>
                ...
                <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="metric-card">
                                <div class="d-flex justify-content-between">
                                    <h6 class="text-muted">Vistas de página</h6>
                        ...
                        <div class="col-md-4">
                            <div class="metric-card">
                                <div class="d-flex justify-content-between">
                                    <h6 class="text-muted">Capacidad del servidor</h6>
                                    <span class="text-muted">Ver</span>
                                </div>
                                <h3>14%</h3>
                                <div class="progress">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="chart-container">
                                <h6 class="text-muted mb-3">Tráfico</h6>
                                <canvas id="trafficChart"></canvas>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="chart-container">
                                <h6 class="text-muted mb-3">Vistas de productos</h6>
